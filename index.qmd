...
- Paquete para manipulación y transfomación de datos, sus raices están en el paquete `plyr`  que implementa la estrategia "split-apply-combine" [paper](https://www.jstatsoft.org/article/view/v040i01) para anális de datos.
...
2. Los siguientes argumentos en general describen las columnas donde se hacen las operaciones, usando el nombre de las variables si comillas
